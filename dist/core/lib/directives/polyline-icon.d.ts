...
export declare class AgmPolylineIcon implements OnInit {
    ...
    strokeWeight: number;
    ngOnInit(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<AgmPolylineIcon, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<AgmPolylineIcon, "agm-polyline agm-icon-sequence", never, { "fixedRotation": { "alias": "fixedRotation"; "required": false; }; "offset": { "alias": "offset"; "required": false; }; "repeat": { "alias": "repeat"; "required": false; }; "anchorX": { "alias": "anchorX"; "required": false; }; "anchorY": { "alias": "anchorY"; "required": false; }; "fillColor": { "alias": "fillColor"; "required": false; }; "fillOpacity": { "alias": "fillOpacity"; "required": false; }; "path": { "alias": "path"; "required": false; }; "rotation": { "alias": "rotation"; "required": false; }; "scale": { "alias": "scale"; "required": false; }; "strokeColor": { "alias": "strokeColor"; "required": false; }; "strokeOpacity": { "alias": "strokeOpacity"; "required": false; }; "strokeWeight": { "alias": "strokeWeight"; "required": false; }; }, {}, never, never, false, never>;
}
