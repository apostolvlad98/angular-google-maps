...
export class AgmDataLayer {
    ...
    static { this.ɵfac = function AgmDataLayer_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || AgmDataLayer)(i0.ɵɵdirectiveInject(i1.DataLayerManager)); }; }
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AgmDataLayer, [{
    ...
    }], () => [{ type: i1.DataLayerManager }], { layerClick: [{
            type: Output
        }], geoJson: [{
            type: Input
        }], style: [{
