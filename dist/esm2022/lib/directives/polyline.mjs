...
export class AgmPolyline {
    ...
    static { this.ɵfac = function AgmPolyline_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || AgmPolyline)(i0.ɵɵdirectiveInject(i1.PolylineManager)); }; }
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AgmPolyline, [{
    ...
    }], () => [{ type: i1.PolylineManager }], { clickable: [{
            type: Input
        }], draggable: [{
            type: Input,
